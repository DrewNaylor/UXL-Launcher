...
- Shouldn't be anything deprecated in this version, though the built-in theme engine will be deprecated once support for the portable theme engine is added.