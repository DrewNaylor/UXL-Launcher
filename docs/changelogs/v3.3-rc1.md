...
- An unfinished theme editor is available simply named `theme-editor`. All it can do at the moment is open a theme and load the colors and stuff into it. I think it only supports TE1.x at the moment.
