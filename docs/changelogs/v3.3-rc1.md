...
- Update [applauncher-icons](https://github.com/DrewNaylor/applauncher-icons) to version 3.0. This has the following benefits: ([pull request #175](https://github.com/DrewNaylor/UXL-Launcher/pull/175))
  - Smoother icons
