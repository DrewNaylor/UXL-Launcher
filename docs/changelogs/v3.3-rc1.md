...
- Maudern has been darkened and is much more visible now. If you still wish to use a slightly-modified version of the previous version, please select `MaudernClassic` in the themes dropdown.
