...
#Region "Try/Catch block for Description theme element."
        ...
        Catch ex As Exception
            ...
            Dim msgResult As Integer = MessageBox.Show("An error occurred that we can't handle yet." & vbCrLf &
                "Would you like to file a bug report online?" & vbCrLf & "Before clicking ""Yes,"" " & vbCrLf & "please write down what you were doing" & vbCrLf & "when the error happened along with the text below." & vbCrLf &
                "Use what you wrote down to fill out the bug report." & vbCrLf &
                "" & vbCrLf &
