...
#Region "Try/Catch block for Description theme element."
        ...
        Catch ex As Exception
            ...
            Dim msgResult As Integer = MessageBox.Show("An error occurred that we can't handle yet." & vbCrLf &
                "Would you like to file a bug report online?" & vbCrLf & "If you choose to report the error, " & vbCrLf & "please write down what you were doing" & vbCrLf & "when the error happened along with the text below before" & vbCrLf &
                "Please fill out the online error report with the information you wrote down." & vbCrLf &
                "" & vbCrLf &
