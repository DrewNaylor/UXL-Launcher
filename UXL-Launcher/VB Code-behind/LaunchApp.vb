...
#Region "The code in this region is for launching the apps when buttons are pressed."
    ...
    Public Shared Sub LaunchAccess()
        ...
        Process.Start(My.Settings.officeDriveLocation & ":\Program Files" & OfficeLocater.cpuTypeString & "\Microsoft Office" & OfficeLocater.officeInstallMethodString & "\Office14\MSACCESS.EXE")
    End Sub
