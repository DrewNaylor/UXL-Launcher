...
#Region "Revert to Default Theme button."
    Private Sub menubarRevertThemeButton_Click(sender As Object, e As EventArgs) Handles menubarRevertThemeButton.Click
        ...
        If My.Settings.enableThemeEngine = True Then
            ...
            UXLLauncher_ThemeEngine.themeEngine_ApplyTheme(Me)
        End If
    End Sub
#End Region
...
#Region "Theme Tester Buttons."
    ...
    Public Shared Sub themeChooser()
        ...
        UXLLauncher_ThemeEngine.themeEngine_ChooseUserTheme(aaformMainWindow)
        UXLLauncher_ThemeEngine.themeEngine_ChooseUserTheme(forceAboutWindowTab)
        UXLLauncher_ThemeEngine.themeEngine_ChooseUserTheme(forceOptionsWindowTab)
    End Sub

    Public Shared Sub themeApplier()
        ' This is the list of forms that the theme engine applies stuff to
        ' when the theme is pre-specified.
        UXLLauncher_ThemeEngine.themeEngine_ApplyTheme(aaformMainWindow)
        UXLLauncher_ThemeEngine.themeEngine_ApplyTheme(forceAboutWindowTab)
        UXLLauncher_ThemeEngine.themeEngine_ApplyTheme(forceOptionsWindowTab)
    End Sub
